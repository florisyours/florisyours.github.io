...
function getMapOfTheDay(number) {
    /* spoilers to the right, do not look!!!!                                                                                                                                                                                                                                            */let firstCorrectMaps = ["Haunted Tower", "Egghunt 3", "Blight", "Jiga's Claymaze", "Chaoskampf", "E", "Its Better Together", "Resource Parkour", "Bugs", "Desert Bus", "Factory", "Minas Tirith"]; // Replace with actual map names
    let map = {};
